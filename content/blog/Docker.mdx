...
the docker daemon `dockerd` listens listens for the docker API and manages all the stuff such as containers, images, networks and volumes. One daemon can also talk to other daemons.
